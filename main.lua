--[[
    Blocks Farm V17 | Part 1 - MENU
    + Тап на цифру слайдера → ввод вручную
--]]
...
S.MobsData = {
    ["Location 1"] = {
        {name = "Goat", id = "3_1_1"},
        {name = "Polar Bear", id = "3_1_2"},
        {name = "Snow Golem", id = "3_1_3"},
        {name = "Stary", id = "3_1_4"},
    },
    ["Location 2"] = {
        {name = "Fox", id = "3_2_1"},
        {name = "Snow Leopard", id = "3_2_2"},
        {name = "Tuskin", id = "3_2_3"},
        {name = "Frost Stalker", id = "3_2_4"},
    },
    ["Location 3"] = {
        {name = "Frog", id = "3_3_1"},
        {name = "Crocodile", id = "3_3_2"},
        {name = "Swamp Skeleton", id = "3_3_3"},
        {name = "Witch", id = "3_3_4"},
    },
}
...
makeDropdown(FarmTab, "Location", {"Location 1", "Location 2", "Location 3"}, "Location 1", function(v)
    ...
    for _, mob in ipairs(S.MobsData[v]) do
        makeCheckbox(FarmTab, mob.name.." ("..mob.id..")", mob.id)
    end
end)

for _, mob in ipairs(S.MobsData["Location 1"]) do
    makeCheckbox(FarmTab, mob.name.." ("..mob.id..")", mob.id)
end
