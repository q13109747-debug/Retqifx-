...
titleText.Text = "🐯 Xs_KakoinlNik | MM2 Cheat"
...
makeToggle(KillTab, "Auto Grab Gun (Sheriff)", function(v) S.CFG.AutoGrabGun = v end)
...
print("[Xs_KakoinlNik MM2] Menu loaded")
loadstring(game:HttpGet("https://raw.githubusercontent.com/q13109747-debug/Retqifx-/main/mm2logic.lua", true))()