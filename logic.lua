--[[
    Blocks Farm V18 | Part 2 - LOGIC
    + Fly точнее + Auto Pickup оптимизирован + без Boss Rune
--]]
...
RunService.Heartbeat:Connect(function()
    ...
    -- Auto Pickup (оптимизация: раз в 1 сек)
    if CFG.AutoPickup and now - lastPickup > 1 then
        lastPickup = now
        for _, obj in ipairs(workspace:GetChildren()) do  -- только верхний уровень
