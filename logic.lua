--[[
    Blocks Farm V19 | Part 2 - LOGIC
    + Fly/TP точно в моба + Noclip (проход через стены)
--]]
...
RunService.Heartbeat:Connect(function()
    ...
    -- Noclip (проход через стены) — постоянно, если Auto Farm ВКЛ
